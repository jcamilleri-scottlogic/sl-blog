...
Novel hosting companies (including [Heata](https://www.heata.co/), [Civo/ Deep Green](https://www.datacenterdynamics.com/en/news/civo-launches-second-uk-cloud-region-with-deep-green/) and [Leafcloud](https://leaf.cloud/)) have turned this model on its head. Instead of building isolated data centres that waste heat through air conditioning, they place servers directly in buildings with consistent heating demand, [specifically care homes, residential buildings](https://www.linkedin.com/pulse/why-data-centres-belong-elderly-homes-isolated-warehouses-cronk-drkee/?) and swimming pools. The waste heat from computation becomes the primary heating source - often displacing expensive and polluting Gas.

![1748281007321.jpg](/uploads/1748281007321.jpg)
