---
title: 'Balancing AI Innovation and Sustainability: Our presentation at HM Treasury
  ID25'
date: 2025-11-12 15:23:00 Z
categories:
...
This isn't merely an environmental concern; it's central to building AI systems that deliver lasting value. True sustainability encompasses environmental, economic, and technological considerations, aligning with the [UN Sustainable Development Goals](https://sdgs.un.org/goals) that the UK government has committed to.

## The Tech Carbon Standard: A Framework for Action

At Scott Logic, we've developed the [Tech Carbon Standard](https://www.techcarbonstandard.org/) to help organisations understand and manage their technology footprint. This open source framework, now [cited in the GOV UK Service Manual](https://www.gov.uk/service-manual/design/environmentally-sustainable-services), helps bridge the gap between sustainability professionals and technologists by providing a common language and approach.
...
We have done [an extensive literature review](https://blog.scottlogic.com/2025/09/16/greener-ai-lit-review.html) of industry and academic material relating to AI sustainability, and it provides a solid evidence base for these positions. Recently, Dr Sacha Luccioni recorded a TED Talk on this topic, and it's a very compelling 10-minute watch.
...
2. Central standards coupled with distributed responsibility provide an effective governance model

3. The UK has an opportunity to be a global leader in sustainable AI innovation
